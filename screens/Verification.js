    ...
    return (
            <View style={{ flex: 1, backgroundColor: COLORS.primary }}>
              ...
              <View style={commonStyles.header}>
                ...
                <Text style={commonStyles.headerTitle}>{t('verification_code.header_title')}</Text>
                <Text style={commonStyles.subHeaderTitle}>{t('verification_code.sub_header_title')}</Text>
              </View>
              <Animatable.View animation="fadeInUpBig" style={commonStyles.footer}>
                <View style={styles.center}>
                  <Text style={commonStyles.inputHeader}>{t('verification_code.enter_code')}</Text>
                </View>
                ...
                <Button
                  title={t('verification_code.verify_button')}
                  isLoading={isLoading}
                  filled
                  onPress={() => verifyCode()}
